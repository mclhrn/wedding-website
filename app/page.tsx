...
import { useEffect, useState, MouseEvent, ChangeEvent, useRef } from "react";
      ...
      <main className={snapDisabled ? "snap-disabled" : undefined}>
        ...
        <section id="EVENT" className="event" aria-labelledby="event-heading">
          <div className="event-content" data-parallax data-speed="0.12">
            ...
            <p className="details">Join us the following dayfor music and drinks at Langtons Bar.</p>
          </div>
        </section>
        ...
        <section id="CAPTURE" className="capture" aria-labelledby="capture-heading">
          ...
          <div className="capture-content">
            ...
            <p>Share your favorite moments with #MandHSayIDo. We&apos;ll keep the memories rolling.</p>
        ...
        <section id="RSVP" className="rsvp" aria-labelledby="rsvp-heading">
          <div data-parallax data-speed="0.22">
            ...
            <form name="rsvp" method="POST" data-netlify="true" data-netlify-honeypot="bot-field">
